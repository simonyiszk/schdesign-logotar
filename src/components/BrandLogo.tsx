...
function BrandLogo(props: BrandLogoProps) {
  ...
  return (
    <IconButton size="large" sx={{ mr: mr }} onClick={() => themeChangeHandler()}>
      <SchdesignIcon sx={{ color: theme.palette.mode === "dark" ? theme.palette.secondary.main : theme.palette.common.white }} />
    </IconButton>
  )
}
