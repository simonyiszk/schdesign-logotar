...
import {
    AppBar, Box, Container, createTheme, IconButton, List, ListItemButton, ListItemText, Slide,
...
function Header(props: HeaderProps) {
    ...
    const appBarBgColor = theme.palette.mode === "dark" ? '#2a2a2a' : theme.palette.primary.main
                                ...
                                <Box sx={{ width: 250 }}
                                    ...
                                    <List>
                                        {reszortok.map((reszort, index) =>
                                            <ListItemButton key={index} selected={index === page} onClick={() => onClick(index)}>
                                                <ListItemText primary={reszort.name} sx={{textTransform: "uppercase"}} />
                                            </ListItemButton>
                                        )}
                                    </List>
                                </Box>
